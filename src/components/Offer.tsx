...
const Offer = () => {
  return (
    <div className="bg-[url('/image/Footer_Section.png')] bg-cover bg-center h-[640px] bg-gray-200 py-24  relative">
      <Image
        src={bottom_right_leaf}
        alt="bg-leaf"
        className="  w-[176px] h-[160px] absolute left-0 bottom-0 "
      />
      <Image
        src={top_Leaf}
        alt="bg-leaf"
        className=" w-[90px] h-[70.03px] absolute right-[2rem]  md:right-[26rem] top-[4rem] "
      />
      <Image
        src={bottom_Leaf}
        alt="bg-leaf"
        className="   bottom_right_leaf
             w-[70px] h-[92px]
      ...
      <Image
        src={group_2}
        alt="bg-leaf"
        className="hidden md:block  bottom_right_leaf w-[54.93px] h-[70.91px] absolute right-[20rem] bottom-[27rem]"
      />
      <Image
        src={fruit_img}
        alt="bg-leaf"
        className="hidden md:block bottom_right_leaf w-[627px] h-[380.5px] absolute bottom-[70px] right-[115px]"
      />
