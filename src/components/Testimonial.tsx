...
const Testimonial = () => {
  return (
    ...
    <Image src={top_Leaf} alt="bg-leaf" className="bottom_right_leaf w-[90px] h-[70.03px] absolute right-[0rem] -top-[4rem] md:right-[2rem] md:-top-[2rem]  lg:right-[13rem] lg:top-[6rem] rotate-[125deg] "  />
    <Image src={top_Leaf} alt="bg-leaf" className=" w-[77px] h-[65px] absolute left-[1rem] top-[2rem] md:left-[0rem] md:top-[5rem] lg:left-[13rem] lg:top-[7rem]  rotate-180 "  />
    <Image src={group_2} alt="bg-leaf" className=" w-[40px] h-[70px] md:w-[61.48px] md:h-[69.19px] absolute right-[5rem] -bottom-[7rem] md:left-[13rem] md:-bottom-[4rem] lg:left-[28rem]  -rotate-45 "  />
    ...
    <div className="flex flex-col md:flex-row justify-around  max-w-[1013px] mx-auto   max-h-[533px] items-center mt-16">
      ...
      <div className="w-[643px]  text-left  flex flex-col items-center bg-[#F4F6F6] py-4 rounded-lg" >
       ...
       <p className="text-left text-lg md:text-xl mt-8"><strong>John Doe -</strong> Professional Chef</p>
        </div>
