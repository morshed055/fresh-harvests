...
const Hero = () => {
  return (
    <div className="      ">
      <div className="relative bg-[url('/image/Bg.png')] bg-cover bg-center py-1">
        <Image
          src={girl_with_bucket}
          alt="Clip_arrow"
          className="absolute bottom-0 right-0 w-[280px] h-[473px] md:-top-[82px] md:-right-[44px] md:w-[695px] md:h-[798px] "
        />
          ...
          <div className="relative">
            ...
            <div className="absolute  md:left-50">
              <Image
                src={Special_offer}
                alt="Clip_arrow"
                className="w-[191.85px] h-[91px] md:w-[331px] md:h-[157px]"
              />
            </div>
          </div>
